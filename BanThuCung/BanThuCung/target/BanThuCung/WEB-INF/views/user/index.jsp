				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="#"
							...
							VIEW</a> <img
							src="<c:url value="/assets/user/img/products/5.jpg"/>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="#"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img
							src="<c:url value="/assets/user/img/products/21.jpg"/>"
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="#"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img
							src="<c:url value="/assets/user/img/products/29.jpg"/>"
						...
						<c:if test="${new_products.size() > 0}">
							<div class="item active">
								...
								<c:forEach var="item" items="${new_products}" varStatus="loop">
									<li class="span3">
										<div class="thumbnail">
											<a class="zoomTool" href="<c:url value="/chi-tiet-san-pham/${item.pro_id}"/>"
												title="add to cart"><span class="icon-search"></span>
												QUICK VIEW</a> <a href="#" class="tag"></a> <a
												href="<c:url value="/chi-tiet-san-pham/${item.pro_id}"/>"><img
												src="<c:url value="/assets/user/img/products/${item.img}.jpg" />"
					...
					<c:forEach var="item" items="${highlight_products}" varStatus="loop">
						<li class="span4">
							<div class="thumbnail">
								<a class="zoomTool" href="<c:url value="/chi-tiet-san-pham/${item.pro_id}"/>"
									title="add to cart"><span class="icon-search"></span>
									QUICK VIEW</a> <a href="<c:url value="/chi-tiet-san-pham/${item.pro_id}"/>"><img
									src="<c:url value="/assets/user/img/products/${item.img}.jpg"/>" alt="" /></a>
								<div class="caption">
									<h5>${item.pro_name}</h5>
									<h4>
										<a class="defaultBtn" href="<c:url value="/chi-tiet-san-pham/${item.pro_id}"/>"
											title="Click to view"><span class="icon-zoom-in"></span></a>
										<a class="shopBtn" href="<c:url value="/addCart/${item.pro_id}" />" title="add to cart"><span
